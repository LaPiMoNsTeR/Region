package pf.haunui.region.updater;
...
public class Updater 
{
	...
	public Updater(JavaPlugin plugin) throws IOException 
	{
		...
		this.jarPath = "http://haunui.ovh/plugins/"+this.plugin.getName()+"/version.txt";
		this.versionPath = "http://haunui.ovh/plugins/"+this.plugin.getName()+"/"+plugin.getName()+".jar";
